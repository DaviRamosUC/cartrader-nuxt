 ...
 <div class="max-auto mt-4 max-w-7xl space-y-4 px-4 xs:px-8 sm:px-10 lg:px-16 pb-16 w-3/5">
  <div>
    <!-- CAR HERO -->
    <div class="mt-10">
      <img src="https://carwow-uk-wp-3.imgix.net/Volvo-XC40-white-scaled.jpg" alt="" class="w-full ">
    ...
    <div class="mt-5">
      <div class="mt-10">
        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Veniam sint dolorem ullam,
      </div>
    </div>
    <!-- CAR DESCRIPTION -->
    <!-- CAR CONTACT -->
    <div class="mt-10">
      ...
      <button type="submit" class="bg-blue-400 text-white px-10 py-3 rounded mt-4">Submit</button>
    </div>
    <!-- CAR CONTACT -->
  </div>
</div>
